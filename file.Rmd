...
## Assignment
In this assignment we need to develop a machine learning model to predict the type of exercise performed based on different types of measurements given. We are given two files: **trainig** and **testing**. The first file is the training file, used to develop our algorithm, and the second is used to make our final predictions.
...
```{r}
setwd("G:/Coursera/MachinLearning")
